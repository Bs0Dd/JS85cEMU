...
function createImageOn(svg){
	...
	svglab.setAttributeNS(null,"id","mkbkeys");
	svglab.setAttributeNS('http://www.w3.org/1999/xlink','href', `${BASEPATH}/bitmaps/keysb.png`);
	svglab.setAttributeNS(null,'x','544');
	svglab.setAttributeNS(null,'y','82');
